  ...
  <div class="mainBox">
    <div class="search">
      <Select style="width:100px">
        <Option v-for="item in wordList" :value="item.value" :key="item.value">{{ item.label }}</Option>
      </Select>
      <div style="margin-left: 20px">
        <Input search enter-button placeholder="请输入检索词" style="width: 300px" @on-search="btnClick"/>
      </div>
    </div>
